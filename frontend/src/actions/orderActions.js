  ...
  try {
    ...
    const config = {
      headers: {
        ...
        Authorization: `Bearer ${JSON.parse(sessionStorage.getItem("user")).token}` /* PASSING IN USER TOKEN AND IF THE USER IN AUTHORISED HE'LL HAVE FULL ACCESS TO HIS PROFILE INFORMATION */,
      },
    };
